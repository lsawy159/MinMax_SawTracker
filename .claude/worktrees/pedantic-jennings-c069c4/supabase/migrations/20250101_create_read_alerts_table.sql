...
DROP POLICY IF EXISTS "Users can view their own read alerts" ON read_alerts;
DROP POLICY IF EXISTS "Users can insert their own read alerts" ON read_alerts;
DROP POLICY IF EXISTS "Users can update their own read alerts" ON read_alerts;
DROP POLICY IF EXISTS "Users can delete their own read alerts" ON read_alerts;
DROP POLICY IF EXISTS "Users can see all read alerts" ON read_alerts;
