...
2. صيغ التواريخ: يجب أن تكون بصيغة YYYY-MM-DD (مثال: 2024-12-31)

3. رقم الجوال: يجب أن يكون رقماً من 10-15 خانة

4. المؤسسة: يجب أن يكون اسم المؤسسة موجوداً في النظام

5. الحقول الإضافية: JSON بصيغة {"key": "value"}
