...
import { EnhancedAlert } from '../alerts/EnhancedAlertCard'
import { EnhancedAlertCard } from '../alerts/EnhancedAlertCard'
import { 
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">عالي</span>
                  </div>
