...
const badgeVariants = cva(
  "touch-feedback inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-medium transition-[transform,background-color,border-color,color] duration-[var(--duration-fast)] ease-[var(--easing-standard)] focus:outline-none",
  {
    variants: {
      variant: {
        default: "border-primary-200 bg-primary-50 text-primary-700 dark:border-primary-800 dark:bg-primary-900/20 dark:text-primary-300",
        ...
        success: "border-success-500/20 bg-success-50 text-success-700 dark:border-success-700/30 dark:bg-success-900/20 dark:text-success-300",
        warning: "border-warning-500/20 bg-warning-50 text-warning-700 dark:border-warning-700/30 dark:bg-warning-900/20 dark:text-warning-300",
        danger: "border-danger-500/20 bg-danger-50 text-danger-700 dark:border-danger-700/30 dark:bg-danger-900/20 dark:text-danger-300",
