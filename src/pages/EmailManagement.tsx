...
export default function SystemCorrespondenceManagement() {
  const { user } = useAuth()
  ...
  const loadEmailSettings = useCallback(async () => {
    ...
    try {
      ...
      console.error('[EmailManagement] Failed to load email settings:', error)
  ...
  const loadStatsAndActivity = useCallback(async () => {
    ...
    try {
      ...
      console.warn('[EmailManagement] loadStatsAndActivity error:', err)
    } finally {
  ...
  const saveEmailSettings = async () => {
    ...
    try {
      ...
      toast.success('تم حفظ إعدادات المراسلات بنجاح')
      await loadEmailSettings()
    } catch (error) {
      console.error('[EmailManagement] Failed to save email settings:', error)
      toast.error('فشل حفظ إعدادات المراسلات')
    } finally {
      setSaving(false)
    }
  }
  ...
  const sendTestEmail = async () => {
    try {
      ...
      console.error('[EmailManagement] sendTestEmail error:', err)
  ...
  const retryAllFailed = async () => {
    try {
      ...
      console.error('[EmailManagement] retryAllFailed error:', err)
  ...
  const clearHistory = async () => {
    try {
      ...
      if (error) throw error
      toast.success('تم مسح سجل المراسلات (الناجحة/الفاشلة)')
      await loadStatsAndActivity()
    } catch (err) {
      console.error('[EmailManagement] clearHistory error:', err)
  ...
  const handleManualBackup = async () => {
    ...
    try {
      ...
      console.error('[EmailManagement] manual backup error:', err)
        ...
        <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg shadow-sm p-2">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-[11px] text-gray-600">الجهة المركزية لكل عناوين البريد وإعدادات الإرسال وقائمة الانتظار</p>
            </div>
          </div>
          ...
          <div className="space-y-2 lg:col-span-2">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-2">
              <div className="flex items-center justify-between mb-1.5">
                <h3 className="text-sm font-bold text-gray-900">سجل المراسلات الأخير</h3>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-2 space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-sm font-bold text-gray-900">بطاقة إعدادات المراسلات</h2>
                  <p className="text-xs text-gray-600">الجهة المركزية لعناوين البريد واستقبال النسخ الاحتياطية</p>
                </div>
                <button
              ...
              <div className="bg-blue-50 border border-blue-100 text-[11px] text-blue-800 rounded-lg p-2.5 flex items-start gap-2">
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="leading-snug">حدود الأيام/الألوان للتنبيهات تُدار من صفحة الإعدادات المركزية (Centralized Settings). هذه الصفحة مخصصة للوجهات والإرسال فقط.</p>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-2">
              ...
              <div className="bg-blue-50 border border-blue-100 text-[11px] text-blue-800 rounded-lg p-2.5 flex items-start gap-2">
                ...
                <div className="space-y-0.5">
                  <p className="font-semibold">ملاحظة هامة</p>
                  <p className="leading-snug">حدود الأيام/الألوان للتنبيهات تُدار من صفحة الإعدادات المركزية. هذه الصفحة تختص بالمراسلات فقط.</p>
                </div>
              </div>
            </div>
          </div>
