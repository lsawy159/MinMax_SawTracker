...
serve(async (req) => {
  ...
  try {
    ...
    console.log('بدء إضافة شركات تجريبية بالإحصائيات...')
    
    // إضافة شركات تجريبية بتواريخ متنوعة
    const testCompanies = [
      {
      ...
      },
      {
        ...
        ending_subscription_moqeem_date: '2026-06-15',
        government_documents_renewal: '2026-03-01',
        max_employees: 6
      },
      {
    ...
    const result = {
      success: true,
      message: 'تم إضافة الشركات التجريبية وإحصائياتها',
      data: {
