-- Create an atomic RPC for inserting obligation headers and lines together.
-- This avoids deferred constraint failures when the UI saves a plan in one step.
...
COMMENT ON FUNCTION public.create_employee_obligation_plan(
  UUID,
  public.obligation_type_enum,
  TEXT,
  NUMERIC,
  ...
  public.obligation_plan_status_enum,
  TEXT
) IS 'Creates one employee obligation header and all monthly lines atomically.';