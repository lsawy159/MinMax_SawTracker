...
- [ ] T012 [P] Create `src/styles/__tests__/tokens.test.ts`: assert token names match between `tokens.css`, `lib/tokens.ts`, and `tailwind.config.js`; verify light/dark body-text contrast ≥ 4.5:1 (compute from HSL values)
