    ...
    const sampleCompanies = [
      {
        ...
        ending_subscription_moqeem_date: new Date('2026-02-12'),
      ...
      },
      {
        ...
        ending_subscription_moqeem_date: new Date('2026-04-15'),
      ...
      },
      {
        ...
        ending_subscription_moqeem_date: new Date('2026-02-05'),
